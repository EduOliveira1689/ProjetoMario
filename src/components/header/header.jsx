  ...
  return (
    <Container>
      <NavigationGroup>
        ...
        <SocialContainer>
          <a
            href="https://www.facebook.com/eduardo.goncalves.7543?mibextid=ZbWKwL"
            target="_blank"
          ...
          <a
            href="https://www.instagram.com/edu.oliveira1689?igsh=MW9sZGwyZ3B5NnNydQ=="
            target="_blank"
            rel="noopener noreferrer"
          >
            <SocialIcon
          ...
          <a
            href="https://www.tiktok.com/discover/filme-do-mario"
            target="_blank"
            rel="noopener noreferrer"
          >
            <SocialIcon
          ...
          <a
            href="https://twitter.com/supermariomovie"
            target="_blank"
            rel="noopener noreferrer"
          >
            <SocialIcon
          ...
          <a
            href="https://www.youtube.com/channel/UCwKlp9jF5YrHspGOnnJjM1g"
            target="_blank"
            rel="noopener noreferrer"
          >
            <SocialIcon
      ...
      {!!selectedSong && (
        <div>
          <ClosePlayerButton onClick={onStopPlayer}>
            Para Musica
          </ClosePlayerButton>
        </div>
      )}
